<template>
  <div class="devices-page" style="display:flex;gap:16px;">
    <div class="page-card" style="width:240px;padding:16px;">
    ...
    <div style="flex:1;">
      ...
      <div class="page-card">
        ...
        <div class="search-bar">
          <el-input v-model="filters.q" placeholder="搜索 UUID / IP / OS" clearable style="width:280px;" @clear="loadList" @keyup.enter="loadList">
          ...
          <el-select v-model="filters.os" placeholder="系统" clearable style="width:140px;">
            <el-option v-for="v in osVersions" :key="v" :label="'iOS ' + v" :value="v" />
          </el-select>
          <el-select v-model="filters.channel" placeholder="渠道" clearable style="width:160px;">
        ...
        >
          ...
          <el-table-column label="浏览器" width="160">
            <template #default="{ row }">
          ...
          <el-table-column prop="first_seen" label="首次上线" width="160">
            <template #default="{ row }">
          ...
          <el-table-column prop="last_seen" label="最近心跳" width="160">
            <template #default="{ row }">
    ...
    <el-dialog v-model="groupDialog" title="设置分组" width="420px">
